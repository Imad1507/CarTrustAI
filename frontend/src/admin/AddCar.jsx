                ...
                <div className="ac-card">
                  ...
                  <div className="ac-row">
                    ...
                    <div className="ac-field">
                      ...
                      <input className="ac-input" type="text" name="model" placeholder="M3" value={formData.model} onChange={handleChange} />
                    </div>
                  </div>
                  <div className="ac-row">
                    <div className="ac-field">
                      <label className="ac-label">Year</label>
                      <input className="ac-input" type="number" name="year" placeholder="2024" value={formData.year} onChange={handleChange} />
                    </div>
                    <div className="ac-field">
